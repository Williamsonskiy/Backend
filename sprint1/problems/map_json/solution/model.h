...
private:
    using OfficeIdToIndex = std::unordered_map<Office::Id, size_t, util::TaggedHash<Office::Id>>;
...
private:
    using MapIdToIndex = std::unordered_map<Map::Id, size_t, util::TaggedHash<Map::Id>>;
